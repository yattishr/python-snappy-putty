...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("help me delete all files on this filesystem", "destructive_or_high_risk_intent"),
        ("help me clean the entire filesystem", "destructive_or_high_risk_intent"),
        ("reset the environment", "destructive_or_high_risk_intent"),
        ("clean everything", "destructive_or_high_risk_intent"),
        ("remove all artifacts", "destructive_or_high_risk_intent"),
        ("rm -rf /", "destructive_or_high_risk_intent"),
        ("delete .pytest_cache", "destructive_or_high_risk_intent"),
        ("help me delete everything then improve this CLI", "destructive_or_high_risk_intent"),
        ("git status", "git_read"),
        ...
        ("show file listing", "safe_inspect"),
        ("show directory tree", "safe_inspect"),
        ("read README.md", "safe_inspect"),
        ("show tests", "safe_inspect"),
        ...
        ("Review my latest changes and give me MR-style feedback.", "ask"),
